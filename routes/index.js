...
// USER
router.route('/newAdmin').post(passport, userControllers.createAdmin)

router.route('/login').post(userControllers.login)

router.route('/verifyToken').post(passport, userControllers.verifyToken)
...
router.route('/projects/home').get(projectControllers.getHomeProjects)
...
router.route('/sendMail').post(mailControllers.sendMail)
